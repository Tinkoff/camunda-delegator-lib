...
class ParentActivityInstanceIdResolver : DelegateArgumentResolver {

    override fun supportsParameter(methodParameter: MethodParameter): Boolean {
        return methodParameter.getAnnotation<ParentActivityInstanceId>() != null
    }
    ...
    override fun resolveArgument(
        ...
        return delegateExecution.parentActivityInstanceId
    }
}
