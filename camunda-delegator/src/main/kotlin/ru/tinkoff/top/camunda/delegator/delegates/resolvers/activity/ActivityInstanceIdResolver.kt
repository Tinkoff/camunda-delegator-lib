...
class ActivityInstanceIdResolver : DelegateArgumentResolver {

    override fun supportsParameter(methodParameter: MethodParameter): Boolean {
        return methodParameter.getAnnotation<ActivityInstanceId>() != null
    }
    ...
    override fun resolveArgument(
        ...
        return delegateExecution.activityInstanceId
    }
}
