...
class CurrentActivityNameResolver : DelegateArgumentResolver {

    override fun supportsParameter(methodParameter: MethodParameter): Boolean {
        return methodParameter.getAnnotation<CurrentActivityName>() != null
    }
    ...
    override fun resolveArgument(
        ...
        return delegateExecution.currentActivityName
    }
}
