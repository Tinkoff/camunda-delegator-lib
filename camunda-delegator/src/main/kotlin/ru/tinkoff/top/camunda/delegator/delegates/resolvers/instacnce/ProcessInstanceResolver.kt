...
class ProcessInstanceResolver : DelegateArgumentResolver {

    override fun supportsParameter(methodParameter: MethodParameter): Boolean {
        return methodParameter.getAnnotation<ProcessInstance>() != null
    }
    ...
    override fun resolveArgument(
        ...
        return delegateExecution.processInstance
    }
}
